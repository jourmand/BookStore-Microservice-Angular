...
namespace BookStore.Endpoints.Oauth.Migrations.AppIdentityDb
{
    ...
    [Migration("20211004085308_InitialModel01")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Oauth.Infrastructures.Data.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("ApplicationUser_Users");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Oauth.Infrastructures.Data.Entities.ApplicationUser", null)
                        .WithMany()
